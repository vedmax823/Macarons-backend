...
namespace DonMacaron.Migrations
{
    ...
    [Migration("20240929212418_AddCreatedAtToIngredientAndAllergenAndUser")]
    partial class AddCreatedAtToIngredientAndAllergenAndUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IngredientMacaron", b =>
                {
                    ...
                    b.Property<Guid>("MacaronsId")
                        .HasColumnType("uuid");

                    b.HasKey("IngredientsId", "MacaronsId");

                    b.HasIndex("MacaronsId");

                    b.ToTable("IngredientMacaron");
                });
